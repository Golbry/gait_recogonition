...
from libs.utils.config import voc320, voc512, coco320, coco512, test320, test512, MEANS
...
parser.add_argument('--dataset', default='test',
                    choices=['voc', 'coco','test'],
                    type=str, help='voc or coco or test')
parser.add_argument('--network', default='resnet101',
                    help='backbone network')
parser.add_argument('--base_model', default='resnet101_reducedfc.pth',
...
def train():
    ...
    if args.dataset == "voc":
        ...
        args.imdb_name = "train_set"
        args.imdbval_name = "test_set"
    # Import config
    if args.dataset == 'coco':
        ...
        cfg = (test320, test512)[args.input_size == 512]
                ...
                print('iter ' + repr(actual_iteration) +
                      (' || ARM Loss Loc: %.4f  || ARM Loss Conf: %.4f' +
                       ...
                       ' || Loss: %.4f ||') % (
                          ...
                          loss.item()) + ' ')
            # save checkpoint.
            if actual_iteration != 0 and actual_iteration % (int(5000 / batch_multiplier)) == 0:
